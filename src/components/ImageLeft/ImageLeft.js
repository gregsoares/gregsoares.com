              ...
              <ul className="list-none mt-6">
                <li className="py-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="text-gray-800">Carefully crafted components</h4>
                    </div>
                  </div>
                </li>
                <li className="py-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="text-gray-800">Amazing page examples</h4>
                    </div>
                  </div>
                </li>
                <li className="py-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="text-gray-800">Dynamic components</h4>
                    </div>
                  </div>
                </li>
              </ul>
